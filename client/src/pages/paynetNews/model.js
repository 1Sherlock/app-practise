...
export default ({
  ...
  effects: {
    * createOrUpdate({payload}, {call, put, select}){
      ...
      const res = yield call(payload.get('path') ? api.updatePaynetNews : api.createPaynetNews, payload);
      if (res.error) {
